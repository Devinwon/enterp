# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2018-03-27 02:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AliasName', models.CharField(blank=True, max_length=100)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='biddinginfo',
            name='PurchseArea',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='purchsearea', to='order.Area'),
        ),
    ]
